...
def get_clean_data(FILENAME, NUM_EDGES, shuffle=True):
    """Wrapper function for to_undirected method."""
    neighborsMap, num_nodes, node_indices, edges = to_undirected(row_generator(FILENAME), NUM_EDGES, shuffle=shuffle)
